    ...
    <div id='features' className="text-center flex flex-col mt-40 text-xs">
        ...
        <div className="flex flex-col justify-between items-start mb-5 gap-y-5 md:flex-row md:mb-14 md:gap-y-0">
            ...
            <div className='flex flex-col items-center gap-3'>
                ...
                <h2 className="font-bold text-base">Store any type of file</h2>
                <p className='p-2 pt-0 leading-5'>
                    Whether you're sharing holidays photos or
                    work documents, Fylo has you covered allowing for all the files
