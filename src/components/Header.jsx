...
const Header = ({toggleFylo}) => {
  return (
    <header className="flex justify-between items-center py-6 pb-1">
        <div onClick={()=> toggleFylo(prev => !prev)} className="cursor-pointer overflow-hidden w-5 lg:w-fit">
